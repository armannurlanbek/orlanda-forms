...
| Local port | `8006` (free; taken: 5432/6432, 23267, 8000–8005, 5678/5679, 3000) |
...
curl -i http://127.0.0.1:8006/healthz # expect 200
curl -i http://127.0.0.1:8006/health  # 200 = app -> router -> primary DB OK
```
